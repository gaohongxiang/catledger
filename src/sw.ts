...
class DynamicExpirationPlugin implements WorkboxPlugin {
    private static readonly SW_CACHE_TIME_HEADER: string = 'catledger-sw-cache-time';
...
const SW_ASSETS_CACHE_NAME: string = 'catledger-assets-cache';
const SW_CODE_CACHE_NAME: string = 'catledger-code-cache';
const SW_MAP_CACHE_NAME: string = 'catledger-map-cache';
const SW_SHARE_CACHE_NAME: string = 'catledger-share-cache';
