...
export const SW_ASSETS_CACHE_NAME: string = 'catledger-assets-cache';
export const SW_CODE_CACHE_NAME: string = 'catledger-code-cache';
export const SW_MAP_CACHE_NAME: string = 'catledger-map-cache';
export const SW_SHARE_CACHE_NAME: string = 'catledger-share-cache';
