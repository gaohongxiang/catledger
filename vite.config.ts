        ...
        plugins: [
            ...
            VitePWA({
                ...
                manifest: {
                    name: '猫账 · CatLedger',
                    short_name: '猫账',
                    description: 'A lightweight, self-hosted personal finance app for everyday bookkeeping.',
                    theme_color: '#C67E48',
                    ...
                    icons: [
                        {
                            src: 'img/brand/catledger-icon-192.png',
                            sizes: '192x192',
                            type: 'image/png'
                        },
                        {
                            src: 'img/brand/catledger-icon-512.png',
                            sizes: '512x512',
                            type: 'image/png'
                        }
                    ],
