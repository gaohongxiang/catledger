...
test('shared contract and server action registry stay in exact sync', () => {
  ...
  const handlers = createActionHandlers({
    ...
    loanService: serviceStub(['installments','installment','installmentSources','setInstallmentProgress','linkInstallmentSource','archiveInstallment','removeInstallmentItem','bookRepayment','assignRepayment','releaseRepayment','transaction','unassigned','list','get','create','update','record','correct','source','reverse','payment','payments','periods','savePeriod','allocatePeriods','planAllocation','periodHistory','previewPlan','generatePlan']),
