...
var frozenPersonalFinanceRoutes = []personalFinanceRouteSpec{
	...
	{method: "POST", path: "/personal_finance/import_batches/payment_accounts/skip.json", handler: "PersonalFinanceImports.PaymentAccountSkipHandler", importGated: true},
	...
	{method: "POST", path: "/personal_finance/import_batches/payment_accounts/restore.json", handler: "PersonalFinanceImports.PaymentAccountRestoreHandler", importGated: true},
	...
	{method: "GET", path: "/personal_finance/events/category_scope.json", handler: "PersonalFinanceOrganizer.EventCategoryScopeHandler"},
