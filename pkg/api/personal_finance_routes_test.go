...
var frozenPersonalFinanceRoutes = []personalFinanceRouteSpec{
	...
	{method: "POST", path: "/personal_finance/billflow/tasks/accounts/exclude.json", handler: "PersonalFinanceBillflow.BillflowTaskAccountsExcludeHandler"},
	{method: "POST", path: "/personal_finance/billflow/tasks/accounts/restore.json", handler: "PersonalFinanceBillflow.BillflowTaskAccountsRestoreHandler"},
	{method: "GET", path: "/personal_finance/billflow/tasks/accounts/rows.json", handler: "PersonalFinanceBillflow.BillflowTaskAccountsRowsHandler"},
	{method: "POST", path: "/personal_finance/billflow/tasks/accounts/skip_rows.json", handler: "PersonalFinanceBillflow.BillflowTaskAccountsSkipRowsHandler"},
	{method: "POST", path: "/personal_finance/billflow/tasks/accounts/restore_rows.json", handler: "PersonalFinanceBillflow.BillflowTaskAccountsRestoreRowsHandler"},
	...
	{method: "GET", path: "/personal_finance/billflow/tasks/categories.json", handler: "PersonalFinanceBillflow.BillflowTaskClassifiedHandler"},
	{method: "GET", path: "/personal_finance/billflow/tasks/merge_groups.json", handler: "PersonalFinanceBillflow.BillflowTaskMergeGroupsHandler"},
	...
	{method: "POST", path: "/personal_finance/billflow/todos/assign_counterpart_account.json", handler: "PersonalFinanceBillflow.BillflowTodoAssignCounterpartAccountHandler"},
