...
func validateSchemaV005PreflightWithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceMigrationPreflightWithContext(c, db, schemaBeansThroughV004(), schemaBeansV005())
}

func verifySchemaV005WithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceTablesWithContext(c, db, schemaBeansThroughV005(), schemaExact)
}

func verifySchemaV005(db *datastore.Database) error {
...
func validateSchemaV007PreflightWithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceMigrationPreflightWithContext(c, db, schemaBeansThroughV006(), schemaBeansV007())
}

func verifySchemaV007WithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceTablesWithContext(c, db, schemaBeansThroughV007(), schemaExact)
}

func verifySchemaV007(db *datastore.Database) error {
	return verifySchemaV007WithContext(context.Background(), db)
}

func validateSchemaV008PreflightWithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceMigrationPreflightWithContext(c, db, schemaBeansThroughV007(), schemaBeansV008())
}

func verifySchemaV008WithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceTablesWithContext(c, db, schemaBeansThroughV008(), schemaExact)
}

func verifySchemaV008(db *datastore.Database) error {
	return verifySchemaV008WithContext(context.Background(), db)
}

func validateSchemaV009PreflightWithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceMigrationPreflightWithContext(c, db, schemaBeansThroughV008(), schemaBeansV009())
}

func verifySchemaV009WithContext(c context.Context, db *datastore.Database) error {
	return verifyPersonalFinanceTablesWithContext(c, db, schemaBeansThroughV009(), schemaExact)
}

func verifySchemaV009(db *datastore.Database) error {
	return verifySchemaV009WithContext(context.Background(), db)
}
