...
func TestCreateNewExcelMSCFBFileBasicDataTables_TableCount_SingleSheet(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/simple_excel_file.xls")
	assert.Nil(t, err)

	tables, err := CreateNewExcelMSCFBFileBasicDataTables(testdata, true)
	assert.Nil(t, err)
	assert.Equal(t, 1, len(tables))
}

func TestCreateNewExcelMSCFBFileBasicDataTables_TableCount_MultipleSheets(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_TableCount_EmptyContent(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/empty_excel_file.xls")
	assert.Nil(t, err)
	...
	tables, err = CreateNewExcelMSCFBFileBasicDataTables(testdata, false)
	assert.Nil(t, err)
	assert.Equal(t, 0, len(tables))
}

func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowCount_SingleSheet(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/simple_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowCount_MultipleSheets(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowCount_DifferentHeaders(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_with_different_header_row_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_HeaderColumnNames(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/simple_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_HeaderColumnNames_DifferentHeaders(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_with_different_header_row_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowIterator_SingleSheet(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/simple_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowIterator_MultipleSheets(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_excel_file.xls")
	assert.Nil(t, err)
...
func TestCreateNewExcelMSCFBFileBasicDataTables_DataRowIterator_DifferentHeaders(t *testing.T) {
	testdata, err := os.ReadFile("../../../testdata/multiple_sheets_with_different_header_row_excel_file.xls")
	assert.Nil(t, err)
