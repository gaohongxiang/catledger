...
import (
	...
	"github.com/gaohongxiang/catledger/pkg/converters/sgml"
...
const ofx1UTF8Encoding = "utf-8" // non-standard ofx 1.x encoding, used by some banks (https://github.com/gaohongxiang/catledger/issues/48)
