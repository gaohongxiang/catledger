...
const ACTIONS = new Set(['loans.create', 'loans.update', 'loans.record', 'loans.reverse', 'transactions.create', 'transactions.update', 'transactions.delete', 'transactions.linkRefund', 'transactions.setCategory'])
