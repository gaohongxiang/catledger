...
const ACTIONS = new Set(['loans.create', 'loans.update', 'transactions.create', 'transactions.update', 'transactions.delete', 'transactions.linkRefund', 'transactions.setCategory'])
