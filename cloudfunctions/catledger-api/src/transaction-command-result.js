...
const ACTIONS = new Set(['loans.create', 'loans.update', 'loans.record', 'loans.reverse', 'loans.correct', 'loans.savePeriod', 'loans.allocatePeriods', 'transactions.create', 'transactions.update', 'transactions.delete', 'transactions.linkRefund', 'transactions.setCategory'])
