...
const ERROR_MESSAGES = Object.freeze({
  ...
  LOAN_COVERAGE_REQUIRED: '请先认领原合同及已有费用覆盖，再启用记费',
  LOAN_CHARGE_DIFFERENCE: '费用与已记金额不同，请先预览并确认更正',
  LOAN_CHARGE_PAUSED: '这项费用已暂停、取消或删除，请先核对',
  LOAN_CHARGE_COVERAGE: '已计费用需要关联明确且尚未清偿的收费项',
...
const PUBLIC_ERROR_CODES = new Set([
  ...
  'EXPORT_CHANGED',
  'EXPORT_EXPIRED',
  'LOAN_COVERAGE_REQUIRED',
  'LOAN_CHARGE_DIFFERENCE',
  'LOAN_CHARGE_PAUSED',
  'LOAN_CHARGE_COVERAGE',
