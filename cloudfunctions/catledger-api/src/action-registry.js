const PUBLIC_ACTIONS = Object.freeze([
  ...
  'loans.installments',
  'loans.installment',
  'loans.installmentSources',
  'loans.setInstallmentProgress',
  'loans.confirmInstallments',
  'loans.linkInstallmentSource',
  'loans.archiveInstallment',
...
function createActionHandlers({ accountService, categoryService, catalogService, profileService, transactionService, loanService, dataExportService }) {
  return {
    ...
    'loans.dueCharges': loanService.dueCharges,
    'loans.syncCharges': loanService.syncCharges,
    'loans.chargeImpact': loanService.chargeImpact,
    'loans.changeCharge': loanService.changeCharge,
    'loans.endCharges': loanService.endCharges,
    'loans.chargePlan': loanService.chargePlan,
    'loans.configureCharges': loanService.configureCharges,
    'loans.pauseCharges': loanService.pauseCharges,
    ...
    'loans.installments': loanService.installments,
    'loans.installment': loanService.installment,
    'loans.installmentSources': loanService.installmentSources,
    'loans.setInstallmentProgress': loanService.setInstallmentProgress,
    'loans.confirmInstallments': loanService.confirmInstallments,
    'loans.linkInstallmentSource': loanService.linkInstallmentSource,
    'loans.archiveInstallment': loanService.archiveInstallment,
    'loans.removeInstallmentItem': loanService.removeInstallmentItem,
    ...
    'loans.previewPlan': loanService.previewPlan,
    'loans.generatePlan': loanService.generatePlan,
