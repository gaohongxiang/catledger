...
const READ_ACTIONS = new Set(['reads.validate', 'profile.get', 'catalog.get', 'categories.list', 'accounts.list',
  'dashboard.get', 'statistics.get', 'transactions.list', 'transactions.refundable',
  'loans.transaction', 'loans.unassigned', 'loans.payment', 'loans.payments', 'loans.list', 'loans.get'])
